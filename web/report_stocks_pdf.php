...
for ($currentmonth = $startmonth; $currentmonth<=$endmonth; $currentmonth++)  {
 ...
 $sql = "select a.visa_cardno, a.bank, b.transaction_id, DATE_FORMAT(b.transaction_date,'%d %M %Y') 'transaction_date', b.purpose, b.amount from visa a, visa_transaction b where a.visa_id = b.visa_id and a.userid = ".$_SESSION['userid'].
		' AND MONTH( b.transaction_date ) = '.$currentmonth.' AND YEAR(b.transaction_date) = '.$currentyear.
