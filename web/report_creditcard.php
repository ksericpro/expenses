...
<title>Reports - Credit Cards</title>
</head>
...
function openPDF(){
	...
	if (check())
		Start('report_creditcard_pdf.php?month='+month+'&year='+year,50,50);
}
-->
</script>
<body onload="init();">
...
<table border="1" width="40%" align=center cellpadding=0 cellspacing=0 style="border-collapse:collapse">
  <tr bgcolor="#52637B">
    <td> <div align="center"><font color="#FFCC00" size="3"><strong>Reports - Credit Cards</strong></font> </div></td>
  </tr>
	<tr>
